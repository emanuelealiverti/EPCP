...
ELBO, so `conv_tr = 1e-7` is a tighter criterion than the default here and
stabilises the smaller variance components; `maxit` is raised accordingly so
that the threshold loop converges rather than stopping at the iteration cap.
