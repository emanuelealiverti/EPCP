...
(2012), and further details can be found in Appendix B.3 of such a
...
```
    ...
    ##            Estimate Std. Error
    ## age         0.5497   0.0907   
    ## genderMale  0.2111   0.0907   
    ## pincome    -0.1836   0.0894   
    ## 
    ## Threshold parameters (cutpoints):
    ##          Estimate
    ## alpha[1] -1.1893 
    ...
    ## alpha[3]  0.0658 
    ## 
    ## Converged in 2 iterations. Approx. log marginal likelihood: -588.9
...
<img src="brazil.png" alt="" width="3300" />
